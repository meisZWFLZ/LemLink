...
export abstract class PackageVersion<ID> {
  ...
  /**
   * @returns A promise that resolves to a Buffer containing the downloaded package, or undefined if the download fails.
   */
  public abstract download(): Promise<Buffer | undefined>;
}

/**
 * Represents an package.
 * Packages can be templates, libraries, and engines.
 * This provides methods to retrieve {@linkcodei PackageVersion versions} of this package.
 *
...
export abstract class Package<ID, V extends PackageVersion<ID>> {
   ...
   *
   * @returns A promise that resolves to the latest package version, or null if no versions are available.
   */
   ...
   * @returns A promise that resolves to the specified package version, or undefined if said version is not found.
   */
   ...
   * @returns A promise that resolves to an array of package versions within the specified range.
   */
   ...
   * @returns A promise that resolves to the latest package version within the specified range, or undefined if no versions are available in the range.
   */
...
/**
 * Represents a way to resolve a {@linkcode Package}.
 * For example, {@linkcode GithubPackageResolver} resolves packages by retrieving them from GitHub.
 * In the future, users should be able to retrieve packages from local packages.
 *
 * @see {Package}
...
> {
  /**
   * Resolves a {@linkcode Package} from an {@linkcode PackageIdentifier identifier}.
   * @param id - Identifies the desired {@linkcode Package}
   * @returns The package indicated by {@linkcode id} or null if it does not exist
   *
   * @see {Package}
